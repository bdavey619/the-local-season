...
|-------|------|-----------|-----------|
| January | **Chennai** (`chennai-january.html`) | The Music Season | Electric |
...
| March | **Cape Town** (`cape-town-march.html`) | The Wind Drops | Local |
...
| May | **Kyoto** (`kyoto-may.html`) | The River Grows a Floor | Open |
...
| `archetype` | Electric / Open / Local / Quiet — also selects the accent color |
...
```jsonc
{
  ...
  "month":     "Month",
  "storyline": "Subtitle",
  "archetype": "Local",            // Electric | Open | Local | Quiet
